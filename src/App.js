...
const G = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media(max-width:640px){.h1big{font-size:28px!important}}
`;
...
const Home = ({currentUser,onNavigate}) => {
  ...
  const heroOverlayOpacity=Math.min(0.85, 0.35 + scrollY / 600);
  return (
    <div style={{background:"var(--cream)"}}>
      <style>{`
        ...
        .hero-shine-text {
          ...
          animation: hero-shine-sweep 3.5s ease-in-out infinite;
        }
        .hero-shine-sub {
          display: inline;
          background-image: linear-gradient(
