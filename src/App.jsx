...
const G = `
  ...
  .home-hero-search { flex: 0 1 380px; max-width: 100%; min-width: 0; width: 100%; border-radius: 26px !important; padding: 0 !important; background: rgba(255,255,255,0.92) !important; border: 1px solid rgba(226,232,240,0.75) !important; box-shadow: 0 2px 12px rgba(15,23,42,0.035), 0 12px 40px rgba(15,23,42,0.055), inset 0 1px 0 rgba(255,255,255,0.98) !important; backdrop-filter: blur(18px) saturate(165%) !important; -webkit-backdrop-filter: blur(18px) saturate(165%) !important; }
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  body { font-family: 'Inter', sans-serif; background: #f8fafc; color: #0f172a; overflow-x: hidden; -webkit-font-smoothing: antialiased; width: 100%; max-width: 100%; }
  ...
  :root {
    ...
    --white: #ffffff; --gray: #f1f5f9; --border: #e2e8f0; --text: #0f172a;
    --muted: #64748b; --shadow: 0 1px 2px rgba(15,23,42,0.05), 0 4px 12px rgba(15,23,42,0.06);
    --shadow-lg: 0 12px 32px rgba(15,23,42,0.08), 0 4px 8px rgba(15,23,42,0.04);
  }
  .card { background: var(--white); border-radius: 16px; border: 1px solid var(--border); box-shadow: var(--shadow); transition: box-shadow 0.25s ease, transform 0.25s ease; }
  .card:hover { box-shadow: var(--shadow-lg); transform: translateY(-2px); }
  .card-flat { background: var(--white); border-radius: 14px; border: 1px solid var(--border); }
  .inp { background: var(--white); border: 1.5px solid var(--border); color: var(--text); border-radius: 10px; padding: 10px 13px; font-size: 14px; width: 100%; outline: none; transition: border 0.2s, box-shadow 0.2s; font-family: inherit; }
  ...
  @media(max-width:768px){
    ...
    #prop-grid{padding:28px max(16px, env(safe-area-inset-left)) 36px max(16px, env(safe-area-inset-right))!important;max-width:100%!important}
  }
...
const Home = ({currentUser,onNavigate}) => {
  ...
  return (
    <div style={{background:"#ffffff",width:"100%",maxWidth:"100%",boxSizing:"border-box"}} className="home-page-shell">
      <section style={{position:"relative",width:"100%",maxWidth:"100%",overflow:"hidden",background:"linear-gradient(165deg, #fafbfc 0%, #f1f5f9 38%, #e8eef5 100%)"}} className="h1big-hero">
        {/* Hero bg */}
      ...
      <section style={{background:"linear-gradient(180deg, #ffffff 0%, #f8fafc 100%)",padding:"60px 24px",borderTop:"1px solid var(--border)",borderBottom:"1px solid var(--border)"}}>
