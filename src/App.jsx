...
const Home = ({currentUser,onNavigate}) => {
  ...
  return (
    <div style={{background:"var(--cream)"}}>
      <section style={{position:"relative",width:"100%",minHeight:"520px",overflow:"hidden",display:"flex",alignItems:"center",background:"linear-gradient(165deg, #f8fafc 0%, #f1f5f9 42%, #e2e8f0 100%)"}} className="h1big-hero">
        {/* Hero bg */}
