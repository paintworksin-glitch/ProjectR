...
const G = `
  ...
  .h1big-hero { min-height: clamp(300px, 38vh, 400px); width: 100%; display: flex; flex-direction: column; align-items: stretch; box-sizing: border-box; }
  .home-hero-inner { position: relative; z-index: 1; width: 100%; max-width: 1180px; margin: 0 auto; padding: 44px 24px; gap: 28px; display: flex; align-items: stretch; justify-content: space-between; flex-wrap: wrap; box-sizing: border-box; flex: 1 1 auto; min-width: 0; }
  .home-hero-text { flex: 1 1 400px; max-width: 600px; min-width: 0; align-self: center; }
  .home-hero-search-wrap { flex: 0 1 400px; max-width: 100%; min-width: 0; display: flex; flex-direction: column; align-self: stretch; }
  .home-hero-search { flex: 0 1 380px; max-width: 100%; min-width: 0; width: 100%; }
  .home-hero-actions { display: flex; gap: 12px; margin-top: 24px; flex-wrap: wrap; }
  .home-hero-tabs { display: flex; width: 100%; justify-content: stretch; gap: 0; margin-bottom: 4px; border-bottom: 1px solid rgba(226,232,240,0.95); }
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media(max-width:768px){
    ...
    .home-hero-inner{padding:24px max(16px, env(safe-area-inset-left)) 28px max(16px, env(safe-area-inset-right))!important;flex-direction:column!important;gap:18px!important;align-items:stretch!important;width:100%!important;max-width:100%!important}
    .home-hero-text{text-align:center!important;max-width:none!important;width:100%!important;margin-left:0!important;margin-right:0!important;flex:0 0 auto!important;align-self:stretch!important}
    ...
    .home-hero-actions{justify-content:center!important;margin-top:18px!important;width:100%!important}
    .home-hero-tab{font-size:13px!important;padding:10px 4px!important}
...
const Home = ({currentUser,onNavigate}) => {
  ...
  return (
    <div style={{background:"var(--cream)",width:"100%",maxWidth:"100%",boxSizing:"border-box"}} className="home-page-shell">
      <section style={{position:"relative",width:"100%",maxWidth:"100%",overflow:"hidden",background:"linear-gradient(165deg, #f8fafc 0%, #f1f5f9 42%, #e2e8f0 100%)"}} className="h1big-hero">
        {/* Hero bg */}
        ...
        <div className="home-hero-inner">
          ...
          <div className="home-hero-text">
            <h1 style={{fontWeight:800,fontSize:"clamp(30px, 4.2vw, 48px)",color:"var(--navy)",lineHeight:1.12,letterSpacing:"-0.02em"}} className="h1big home-heading">
              Northing to your dream home
            </h1>
            <p style={{fontSize:16,color:"var(--muted)",marginTop:14,lineHeight:1.65,maxWidth:460,fontWeight:500}}>
              Browse thousands of listings, connect with agents, and find the perfect home.
            </p>
            <div className="home-hero-actions">
              <button onClick={()=>onNavigate("feed")} className="btn-primary" style={{padding:"14px 26px",borderRadius:12,fontSize:14,border:"none",display:"flex",alignItems:"center",gap:8}}>🏠 Browse Properties</button>
              <button onClick={()=>onNavigate(currentUser?"dashboard":"login")} className="btn-outline" style={{padding:"14px 26px",borderRadius:12,fontSize:14}}>📋 List Your Property</button>
            </div>
          </div>
          ...
          <div className="glass-panel home-hero-search" style={{borderRadius:20,padding:"20px 20px 24px"}}>
            <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:16}}>
              <span style={{fontSize:18,opacity:0.85}}>🔍</span>
              <h3 className="home-heading" style={{fontSize:18,fontWeight:800,color:"var(--navy)",margin:0,letterSpacing:"-0.02em"}}>Quick Search</h3>
            </div>
            ...
            <div style={{marginBottom:16}}>
              ...
              <input className="inp" placeholder="Location" value={filter.location} onChange={e=>setFilter(f=>({...f,location:e.target.value}))} style={{width:"100%",padding:"9px 12px",fontSize:13}}/>
            </div>
            <button onClick={()=>document.getElementById("prop-grid")?.scrollIntoView({behavior:"smooth"})} className="btn-primary" style={{width:"100%",padding:"12px",borderRadius:10,fontSize:14,border:"none"}}>Search Properties</button>
          </div>
          </div>
        </div>
      </section>
