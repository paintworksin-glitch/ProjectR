...
const G = `
  ...
  .h1big-hero { min-height: clamp(300px, 38vh, 400px); display: flex; align-items: center; }
  .home-hero-inner { position: relative; z-index: 1; width: 100%; max-width: 1180px; margin: 0 auto; padding: 44px 24px; gap: 28px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; }
  .home-hero-text { flex: 1 1 400px; max-width: 600px; min-width: 0; }
  .home-hero-search { flex: 0 1 380px; max-width: 100%; min-width: 0; }
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media(max-width:768px){
    ...
    .h1big-hero{min-height:0!important;align-items:flex-start!important}
    .home-hero-inner{padding:26px 16px 32px!important;flex-direction:column!important;gap:20px!important;align-items:stretch!important}
    .home-hero-text{text-align:center!important;max-width:none!important;margin-left:auto!important;margin-right:auto!important}
    .home-hero-text p{margin-left:auto!important;margin-right:auto!important}
    .home-hero-search{flex:1 1 auto!important;width:100%!important}
    .home-hero-actions{justify-content:center!important;margin-top:18px!important}
    #prop-grid{padding:28px 16px 36px!important}
  }
...
const Home = ({currentUser,onNavigate}) => {
  ...
  return (
    <div style={{background:"var(--cream)"}}>
      <section style={{position:"relative",width:"100%",overflow:"hidden",background:"linear-gradient(165deg, #f8fafc 0%, #f1f5f9 42%, #e2e8f0 100%)"}} className="h1big-hero">
        {/* Hero bg */}
        ...
        <div className="home-hero-inner">
          ...
          <div className="glass-panel home-hero-search" style={{borderRadius:20,padding:"24px 24px"}}>
